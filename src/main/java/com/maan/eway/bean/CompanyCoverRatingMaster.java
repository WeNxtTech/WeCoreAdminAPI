...
/**
* Domain class for entity "CompanyCoverRatingMaster"
*
...
@DynamicUpdate
@Builder
@IdClass(CompanyCoverRatingMasterId.class)
@Table(name="company_cover_rating_master")


public class CompanyCoverRatingMaster implements Serializable {
