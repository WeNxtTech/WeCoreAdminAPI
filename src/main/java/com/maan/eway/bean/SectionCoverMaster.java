...
public class SectionCoverMaster implements Serializable {
	...
	@ColumnDefault("'0'")
	@Column(name = "IS_EDIT_YN")
	private String isEditYn;

	@ColumnDefault("'0'")
	@Column(name = "IS_RATE_EDIT_YN")
	private String isRateEditYn;

	@ColumnDefault("'0'")
	@Column(name = "IS_PREMIUM_EDIT_YN")
	private String isPremiumEditYn;

	@ColumnDefault("'0'")
	@Column(name = "IS_DISCOUNT_YN")
	private String isDisCountYn;

	@ColumnDefault("'0'")
	@Column(name = "IS_LOADING_YN")
	private String isLoadingYn;
	
	
	@Column(name = "COVER_GROUP")
