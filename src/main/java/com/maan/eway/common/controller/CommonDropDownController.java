...
public class CommonDropDownController {
	...
	public ResponseEntity<CommonRes> coverNoteType() {
		...
		List<DropDownRes> res = service.coverNoteType();
	...
	public ResponseEntity<CommonRes> paymentmode() {
		...
		List<DropDownRes> res = service.paymentmode();
		data.setCommonResponse(res);
		data.setIsError(false);
		data.setErrorMessage(Collections.emptyList());
		data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> endorsementtype() {
			...
			List<DropDownRes> res = service.endorsementtype();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> discounttypeoffered() {
			...
			List<DropDownRes> res = service.discounttypeoffered();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> taxexcempted() {
			...
			List<DropDownRes> res = service.taxexcempted();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> taxexcemptiontype() {
			...
			List<DropDownRes> res = service.taxexcemptiontype();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> policyholdertype() {
			...
			List<DropDownRes> res = service.policyholdertype();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> policyholderidtype() {
			...
			List<DropDownRes> res = service.policyholderidtype();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
		...
		public ResponseEntity<CommonRes> policyholdergender() {
			...
			List<DropDownRes> res = service.policyholdergender();
			data.setCommonResponse(res);
			data.setIsError(false);
			data.setErrorMessage(Collections.emptyList());
			data.setMessage("Success");
