...
/**
* <h2>RawPersonalAccidentController</h2>
*/
@RestController
@Api(tags = "Personal Accident ", description = "API's")
@RequestMapping("/api")
public class RawPersonalAccidentController {

	@Autowired
	private PrintReqService reqPrinter;
	
	@Autowired
	private  RawPersonalAccidentService service;
	...
	public ResponseEntity<CommonRes> personalAccident(@RequestBody RawPersonalAccidentSaveReq req){
