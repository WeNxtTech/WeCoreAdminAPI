...
public class FactorRatingBatchController {
	...
	@PostMapping("/convertExcelToCSV/{product_id}")
	public CommonRes convertExcelToCSV(@PathVariable("product_id") Integer product_id,@RequestParam("file") MultipartFile file) {
		return service.convertExcelToCSV(file,product_id);
	}
